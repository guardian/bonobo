...
object CommercialForm {
  ...
  val requestKeyForm: Form[CommercialRequestKeyFormData] = Form(
    mapping(
      ...
      "businessArea" -> nonEmptyText(minLength = 2, maxLength = 200),
      "monthlyUsers" -> number,
      "commercialModel" -> nonEmptyText(minLength = 2, maxLength = 200),
      "content" -> nonEmptyText(minLength = 2, maxLength = 200),
      "articlesPerDay" -> number,
      "contentFormat" -> nonEmptyText(minLength = 2, maxLength = 200),
